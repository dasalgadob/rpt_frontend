...
import CreatePositionModal from '@/app/companies/[id]/goals/components/CreatePositionModal';
...
const PositionSelect = ({ 
  ...
  const swrKey = companyId ? `${process.env.NEXT_PUBLIC_API_URL}/companies/${companyId}/positions` : null;
